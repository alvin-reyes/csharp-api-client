...
namespace io.spfs.NeutoSpfs.Test
{
    ...
    public class AccountApiTests
    {
        ...
        /// <summary>
        /// Test GenerateAccountUsingGET
        /// </summary>
        [Test]
        public void GenerateAccountUsingGETTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GenerateAccountUsingGET();
            //Assert.IsInstanceOf<GeneratedAccount> (response, "response is GeneratedAccount");
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string nemAddress = null;
            //var response = instance.GetNemAddressDetailsUsingGET(nemAddress);
